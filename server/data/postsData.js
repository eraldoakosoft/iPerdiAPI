...
exports.savePost = function(post){
    ...
    [post.id_usuario, post.nome,post.nome_mae, post.data_nascimento, post.genero, post.numero_documento, post.tipo, post.local_encontrado, post.data_encontrado, post.descricao, post.recompensa, true, post.tipo_postagem, post.created_at, post.updated_at]);
};
