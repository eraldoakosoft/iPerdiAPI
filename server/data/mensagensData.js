...
exports.deleteMsg = function(id){
    return database.none('DELETE FROM mensagem WHERE id_mensagem = $1', [id]);
};
...
exports.updateStatusMsg = function(id, status){
    return database.none('UPDATE mensagem SET status = $1 WHERE id_mensagem = $2', [status, id])
}

exports.getMsg = function(id){
    return database.oneOrNone('SELECT * FROM mensagem WHERE id_mensagem = $1', [id]);
};
